...
async function onPreBootstrap({
  ...
  const functionsDirectoryPath = _path2.default.join(siteDirectoryPath, `src/api`);

  const functionsDirectory = _path2.default.resolve(siteDirectoryPath, functionsDirectoryPath);
